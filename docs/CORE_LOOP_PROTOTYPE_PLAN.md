...
> **Superseded (2026-09-20).** The current design is
> [`docs/prototypes/PORTFOLIO_JUDGMENT_GAME_SPEC.md`](./prototypes/PORTFOLIO_JUDGMENT_GAME_SPEC.md): a compact 8 to 12 minute
> judgment game for a portfolio site. This one-day management plan (costed clock, Jenny minute menu, memory consolidation,
> hypothesis toggle) is kept as reference for later slices and is not the target.
